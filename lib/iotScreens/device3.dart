...
class device3 extends StatefulWidget {
  device3({this.uid, this.uname, this.uemail});
  final String uid;
  final String uname;
  final String uemail;
  @override
  _device3State createState() =>
      _device3State(uid: this.uid, uname: this.uname, uemail: this.uemail);
}

class _device3State extends State<device3> {
  _device3State({this.uid, this.uname, this.uemail});
  final String uid;
  final String uname;
  final String uemail;
  bool value1 = false;
