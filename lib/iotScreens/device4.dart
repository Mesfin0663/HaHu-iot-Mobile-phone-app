...
class device4 extends StatefulWidget {
  device4({this.uid, this.uname, this.uemail});
  final String uid;
  final String uname;
  final String uemail;
  @override
  _device4State createState() =>
      _device4State(uid: this.uid, uname: this.uname, uemail: this.uemail);
}

class _device4State extends State<device4> {
  _device4State({this.uid, this.uname, this.uemail});
  final String uid;
  final String uname;
  final String uemail;
  String device = "Device_4";
  bool value1 = false;
  bool value2 = false;
  bool value3 = false;
  bool value4 = false;
